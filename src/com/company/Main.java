...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SalariedEmployee s1 = new SalariedEmployee(1 , "Rizwan" , 40.0 , 10000.0);
        SalariedEmployee s2 = new SalariedEmployee(2 , "Umer" , 50.0 , 15000.0);
        ...
        CommissionedEmployee c1 = new CommissionedEmployee(5 , "Atif" , 80.0 , 10000.0 , 500.0);
